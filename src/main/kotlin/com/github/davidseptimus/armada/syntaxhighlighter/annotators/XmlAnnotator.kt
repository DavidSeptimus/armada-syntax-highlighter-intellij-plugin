...
class XmlAnnotator : BaseArmadaAnnotator() {
    ...
    private fun annotateDocType(element: PsiElement, holder: AnnotationHolder) {
        ...
        if (element.elementType == XmlTokenType.XML_DOCTYPE_START
            || element.elementType == XmlTokenType.XML_DOCTYPE_END
            || element.elementType == XmlTokenType.XML_DOCTYPE_SYSTEM
            || element.elementType == XmlTokenType.XML_DOCTYPE_PUBLIC
        ) {
